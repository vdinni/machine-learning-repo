...
bucket = storage_client.bucket("vjd-mlops-bucket")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "newton-ml-426910.vj_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://vjd-mlops-bucket/bank_campaign_data/bank-additional.csv"
    model_name='xgboost'
